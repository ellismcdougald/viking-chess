...
void MoveGenerator::add_pseudo_legal_pawn_moves(Board &board, Color color, MoveList& moves) {
...
void MoveGenerator::add_pseudo_legal_piece_moves(Board &board, Color color, Piece piece, MoveList& moves) {
...
void MoveGenerator::add_pseudo_legal_en_passant_moves(Board &board, Color color, MoveList& moves) {
...
void MoveGenerator::add_legal_castle_moves(Board &board, Color color, MoveList& moves) {
  add_legal_kingside_castle_move(board, color, moves);
  add_legal_queenside_castle_move(board, color, moves);
}

void MoveGenerator::add_legal_kingside_castle_move(Board &board, Color color, MoveList& moves) {
...
void MoveGenerator::add_legal_queenside_castle_move(Board &board, Color color, MoveList& moves) {
  // if color has no castle rights, don't add move
...
void MoveGenerator::add_moves(bitboard origin, bitboard all_destinations, char flag, MoveList& moves) {
...
void MoveGenerator::add_promotion_moves(bitboard origin, bitboard all_destinations, bool capture, MoveList& moves) {
