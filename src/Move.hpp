 ...
 * Bits 1 - 6: From index (0 - 63)
 * Bits 7 - 12: To index (0 - 63)
 * Bits 13 - 16: flags
...
public:
  ...
  // Getters:
  inline bitboard get_origin() { return ((bitboard) 1) << ((move_rep & 0xFC00) >> 10); }
  inline bitboard get_destination() { return ((bitboard) 1) << ((move_rep & 0x3F0) >> 4); }
  ...
  inline void set_destination(bitboard dest) { move_rep = move_rep & 0xFC0F | (lsb(dest) << 4); }
